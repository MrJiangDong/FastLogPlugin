...
import com.jyc.library.fast.log.util.FastLogDisplayUtil;

/// @author jyc
/// 创建日期：2021/4/26
/// 描述：FastViewPrinterProvider
public class FastViewPrinterProvider {
    ...
    public FastViewPrinterProvider(FrameLayout rootView, RecyclerView recyclerView) {
    ...
    public void showFloatingView() {
        ...
        params.bottomMargin = FastLogDisplayUtil.dp2px(100, recyclerView.getResources());
    ...
    private void showLogView() {
        ...
        FrameLayout.LayoutParams params =
                new FrameLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, FastLogDisplayUtil.dp2px(160, rootView.getResources()));
